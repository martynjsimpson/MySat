...
MySat is a CubeSat-style embedded project built around three collaborating parts:

- `satellite-firmware/` - firmware for an Arduino MKR WiFi 1010
- `ground-station-firmware/` - firmware for an Arduino Mega 2560 ground station
...
- `platformio.ini` - root PlatformIO config for the satellite firmware
...
- The satellite and ground-station firmware use separate PlatformIO projects to keep build tooling and IntelliSense stable.
